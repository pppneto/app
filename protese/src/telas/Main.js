    ...
    render() {
        ...
        return (
            <View style={styless.mainView}>
                ...
                <View style={{ flex: 1 }}>
                    <ActionButton>
                        <ActionButton.Item title="Conectar à prótese" size={40} onPress={() => this.setState({ showBtModal: true })}>
                            <Icon name='bluetooth-b' style={styless.actionButtonIcon} />
                        </ActionButton.Item>
                        <ActionButton.Item title="Analisar gráfico" size={40} onPress={() => this.props.navigation.navigate('Grafico')}>
                            <Icon name='area-chart' style={styless.actionButtonIcon} />
                        </ActionButton.Item>
                    </ActionButton>
                </View>
